...
class UserLogic extends BaseLogic
{
    ...
    public static function info(int $userId)
    {
        $user = User::where(['id' => $userId])
            ->field('id,sn,external_sn,sex,account,password,nickname,real_name,avatar,mobile,create_time,user_money,freeze_money,is_disable,ad_perm,total_award_price')
            ->findOrEmpty();
        $user['has_password'] = !empty($user['password']);
