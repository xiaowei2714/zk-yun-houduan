...
use app\adminapi\lists\NoticeLists;
use app\adminapi\logic\NoticeLogic;
...
class NoticeController extends BaseAdminController
{
    ...
    public function add()
    {
        $params = (new NoticeValidate())->post()->goCheck('add');
        $result = NoticeLogic::add($params);
        if (true === $result) {
    ...
    {
        $params = (new NoticeValidate())->post()->goCheck('edit');
    ...
    {
        $params = (new NoticeValidate())->post()->goCheck('delete');
        NoticeLogic::delete($params);
